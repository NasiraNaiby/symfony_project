 ...
 */
final class Version20250224134556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job ADD created_at DATETIME DEFAULT NULL, ADD update_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile DROP created_at, DROP update_at');
